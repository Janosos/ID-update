...
export default function GlobalLayout({ children }: { children: React.ReactNode }) {
  ...
  const isDemoPage = pathname ? pathname.startsWith("/demos") : false;
  ...
  useEffect(() => {
   ...
   return (
     <div id="id-global-wrapper" className="min-h-screen d-flex flex-column">
       ...
       {/* Hide navbar on Mothers Day and Demo Pages */}
       {!isMothersDay && !isDemoPage && (
       ...
       {/* Page Content */}
       <main className={`flex-grow-1 ${(!isMothersDay && !isDemoPage) ? "pt-5 mt-4" : ""}`}>
         {children}
       </main>
 
       {/* Hide footer on Mothers Day and Demo Pages */}
       {!isMothersDay && !isDemoPage && (
       ...
       {!isMothersDay && !isDemoPage && <ChatBot />}
